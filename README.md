...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .card h3{font-size:17px;margin-bottom:8px;color:var(--accent-2)}
    ...
    <main id="posts">
      <div class="grid">
        <article class="card">
          ...
          <h3>Harapan terhadap MK Basis Data</h3>
          <p>Harapan saya di mata kuliah ini bisa lebih ngerti gimana cara bikin database dari nol, mulai dari konsep sampai prakteknya. Jadi bukan cuma bisa teori aja, tapi juga bisa pakai DBMS seperti MySQL untuk proyek aplikasi.</p>
        </article>

        <article class="card">
          <div class="num">#02</div>
          <h3>Apa itu Basis Data?</h3>
          <p>Basis data itu tempat nyimpen data yang sudah diatur rapi biar gampang dicari, ditambah, diubah, atau dihapus. Intinya, semua data dikumpulin jadi satu sistem biar lebih efisien dan nggak berantakan.</p>
        </article>

        <article class="card">
          <div class="num">#03</div>
          <h3>Apa itu Conceptual DB?</h3>
          <p>Conceptual database itu model gambaran umum dari database. Biasanya kita bikin pake ERD (Entity Relationship Diagram), yang nunjukin entitas, atribut, dan hubungan antar entitas, tapi belum mikirin detail teknisnya.</p>
        </article>

        <article class="card">
          <div class="num">#04</div>
          <h3>Apa itu Physical Model?</h3>
          <p>Physical model itu sudah lebih teknis, nunjukin gimana database beneran diimplementasikan di DBMS. Isinya detail kayak struktur tabel, tipe data tiap kolom, primary key, foreign key, sampai indeks biar query lebih cepat.</p>
        </article>
      </div>
